...
api.add_resource(BookableItemofUser, "/api/users/<userID>/my_bookables/<bookableID>/")
api.add_resource(SlotCollectionofUser, "/api/users/<userID>/my_bookables/<bookableID>/slots/")
api.add_resource(SlotItemofUser, "/api/users/<userID>/my_bookables/<bookableID>/slots/<slotID>/")
